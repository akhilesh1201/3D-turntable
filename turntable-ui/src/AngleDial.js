...
const AngleDial = ({ angle, label, letter }) => {
  ...
  <circle
    cx={radius}
    cy={radius}
    r={radius - 2}       // slightly smaller than the SVG size
    stroke="white"       // color of the outer border
    strokeWidth="4"      // thickness of the outer border
    fill="none"          // make sure the inside is transparent so the black dial shows
  />
